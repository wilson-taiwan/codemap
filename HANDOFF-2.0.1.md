...
- Every release will now publish optional, version-pinned QA-runner assets for its supported platforms:
  - `Fleuron_<version>_macos-qa-runner.zip`
  - `Fleuron_<version>_windows-qa-runner.zip`
- The release workflow validates, inventories, checksums, and attests both runner archives.
