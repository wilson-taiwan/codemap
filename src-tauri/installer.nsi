; Vendored from Tauri CLI v2.11.3
; Upstream Tag: tauri-cli-v2.11.3
; Upstream URL: https://raw.githubusercontent.com/tauri-apps/tauri/tauri-cli-v2.11.3/crates/tauri-bundler/src/bundle/windows/nsis/installer.nsi
...
Function PageLeaveReinstall
  ...
  ; In update, passive, or silent mode, always proceed without uninstalling
  ${If} $UpdateMode = 1
  ${OrIf} $PassiveMode = 1
  ${OrIf} ${Silent}
    Goto reinst_done
...
Section WebView2
  ...
  ${If} $4 == ""
    ...
    ${OrIf} ${FileExists} "$PROGRAMFILES\Microsoft\EdgeWebView\Application\*\msedgewebview2.exe"
    ${OrIf} ${FileExists} "$LOCALAPPDATA\Microsoft\EdgeWebView\Application\*\msedgewebview2.exe"
      StrCpy $4 "1.0.0.0"
    ${EndIf}
  ${EndIf}
...
Section Uninstall
  ...
  !endif
    ...
    ; Removes upstream name-wide process check macro; hook performs bounded wait
