...
| --- | --- |
| macOS (Intel or Apple Silicon) | `Fleuron_2.1.0_universal.dmg` |
...
1. Double-click `Fleuron_2.1.0_x64-setup.exe`.
...
shasum -a 256 Fleuron_2.1.0_universal.dmg
```

Verify against the published `SHA256SUMS.txt` on the release page:

```bash
gh release download v2.1.0 --repo wilson-taiwan/fleuron --dir .
